...
The **best**, **worst**, and **average** cases of a given algorithm expresses what the resource usage (i.e. complexity) is _at least_, _at most_ and _on average_, respectively. 
