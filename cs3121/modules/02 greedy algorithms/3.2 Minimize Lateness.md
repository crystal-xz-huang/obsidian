---
aliases: [Minimizing Job Lateness, Scheduling to Minimize Maximum Lateness, Scheduling with Deadlines]
---
...
Similar to [[2.1 Activity Selection|Interval Scheduling]]. Except instead of start and finish times, each request $i$ has:
