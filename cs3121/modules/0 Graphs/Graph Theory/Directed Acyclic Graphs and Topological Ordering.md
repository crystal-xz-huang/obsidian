...
A **directed acyclic graph (DAG)** is exactly that: a directed graph without (directed) cycles.

![[dag.png|200]]

In a directed graph, a **topological ordering** of the vertices is one in which all edges point “left to right”.
