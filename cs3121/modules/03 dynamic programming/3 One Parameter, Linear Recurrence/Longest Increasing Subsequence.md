...
> [!problem]
> Given a sequence of $n$ real numbers $A[1..n]$. 
> The task is to find the longest increasing subsequence in $A[1..n]$
> 
...
![[wk3-LIS-annotation.excalidraw.png|300]]
...
![[wk3-LIS-annotation-1.excalidraw.png|400]]
...
![[wk3-LIS-proof.excalidraw.png|500]]
