...
> 
> > Note that we want to find the maximum **_number_** of activities, **not** necessarily the maximum **_use_** of the resource 
> > — this is not the same as maximizing the time/duration for the resource to be used.

## Problem Example: Interval Scheduling

![[wk2-activity-selection.png]]
...
| ![[wk2-activity-selection-attempt-1.png\|300\|figure]] |
| :----------------------------------------------------: |
...
|                                                                                                                                                                        ![[wk2-activity-selection-attempt-2.png\|figure]]                                                                                                                                                                        |
| --------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
...
|                        ![[wk2-activity-selection-attempt-2_3.png]]                         |
| :----------------------------------------------------------------------------------------: |
...
- To do this, we need the following:
	- Create (or pass) an array $f$ containing the _finish times_ of the activities in A.
	- Create (or pass) an array $s$ containing the _start times_ of the activities in A.
...
![[wk2-activity-selection-exchange.excalidraw.png]]
...
> 
> > [!answer]- Explanation
> > Suppose that $A$ has _more_ activities than greedy, so $s > r$. 
...
If the objective is to maximise the <b>duration</b> of non-conflicting activites, then any interval being *just as good* for the objective isn’t true anymore.
...
The "weighted" version of the activity selection problem involves selecting an optimal set of non-overlapping activities such that the total weight is maximized.
